...
- **New pursuits get a birth credit.** Adding one mid-week doesn't treat
  ...
  counts against it.
- **Every Monday 00:00 resets the week.** Surplus and shortfall both die
  at the boundary — overshoot does not bank into next week, and you never
  owe a missed week either.
...
Effective progress is $\tilde{d}_i(t) = d_i(t) + c_i$. At each Monday
00:00 the week window rolls; neither surplus nor deficit carries.
